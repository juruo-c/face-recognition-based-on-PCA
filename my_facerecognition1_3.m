function my_facerecognition1_0
clear
close all
high=50;
wide=40;
...
for i=1:k_all
    for j=1:k_train
        if(i<10)
           a=imread(strcat('D:\PCA(eigenface for recognition)\AR_Gray_50by40\AR00',num2str(i),'-',num2str(j),'.tif'));     
        else
           a=imread(strcat('D:\PCA(eigenface for recognition)\AR_Gray_50by40\AR0',num2str(i),'-',num2str(j),'.tif'));  
        end  
